                        ...
                        "fields": [
                            {
                                ...
                                "code": "outcome_statement",
                                "field_type": T,
                                "required": True,
                            },
                            {
                                "label": "Outcome Indicator",
                                "code": "outcome_indicator",
                                "field_type": T,
                                "required": True,
                            },
                            {
                            ...
                            {"label": "Actual", "code": "actual", "field_type": DEC},
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "actual / annual_target * 100",
                            },
                        ],
                    }
                ],
                        ...
                        "fields": [
                            {
                                ...
                                "code": "output_statement",
                                "field_type": T,
                                "required": True,
                            },
                            {
                                "label": "Output Indicator",
                                "code": "output_indicator",
                                "field_type": T,
                                "required": True,
                            },
                            {"label": "Target", "code": "target", "field_type": DEC},
                            {"label": "Actual", "code": "actual", "field_type": DEC},
                            {
                                ...
                                "code": "status",
                                "field_type": DD,
                                "options": ["On Track", "Partially Met", "Not Met"],
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "actual_achievement / quarter_target * 100",
                            },
                            {
                                "label": "Status",
                                "code": "status",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Target", "code": "target", "field_type": DEC},
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "(midline_value - baseline_value) / (target - baseline_value) * 100",
                            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {
                                "label": "Unintended Impacts",
                                "code": "unintended_impacts",
                                "field_type": MT,
                            },
                            {
                                "label": "Recommendations",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {
                                "label": "Program Contribution",
                                "code": "program_contribution",
                                "field_type": DD,
                                "options": [
                                    "Full",
                                    "Significant",
                        ...
                        "fields": [
                            {
                                ...
                                "code": "products_developed",
                                "field_type": MT,
                            },
                            {
                                "label": "Knowledge Sharing Activities",
                                "code": "sharing_activities",
                                "field_type": MT,
                            },
                            {
                                "label": "Recommendations",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {
                                "label": "Sharing Mechanisms",
                                "code": "sharing_mechanisms",
                                "field_type": MT,
                            },
                            {
                                "label": "Recommendations for Scaling",
                                "code": "scaling_recommendations",
                                "field_type": RT,
                            },
                        ],
                    }
