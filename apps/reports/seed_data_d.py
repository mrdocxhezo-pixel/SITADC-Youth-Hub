                    ...
                    },
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "preferred_programs",
                                "field_type": MT,
                            },
                            {
                                "label": "Reference Contact",
                                "code": "reference_contact",
                                "field_type": T,
                            },
                            {
                                "label": "Status",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "withdrawn_members",
                                "field_type": INT,
                            },
                            {
                                "label": "Suspended Members",
                                "code": "suspended_members",
                                "field_type": INT,
                            },
                            {
                                "label": "Closing Membership",
                                "code": "closing_membership",
                                "field_type": INT,
                                "is_calculated": True,
                                "formula": "opening_membership + new_members - withdrawn_members",
                            },
                            {
                                "label": "Growth Rate",
                                "code": "growth_rate",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "new_members / opening_membership * 100",
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "(closing_membership / opening_membership) * 100",
                            },
                        ],
                    }
                ],
                        ...
                        "fields": [
                            {
                                ...
                                "code": "total_applications",
                                "field_type": INT,
                                "is_calculated": True,
                                "formula": "sum(applications_received)",
                            },
                            {
                                "label": "Total Recruited",
                                "code": "total_recruited",
                                "field_type": INT,
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "total_recruited / total_applications * 100",
                            },
                            {
                                "label": "Recruitment Challenges",
                                "code": "recruitment_challenges",
                                "field_type": MT,
                            },
                            {
                                "label": "Recommendations",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "status",
                                "field_type": DD,
                                "options": ["Active", "Completed", "Withdrawn"],
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(hours_contributed)",
                            },
                            {
                                "label": "Programs Covered",
                                "code": "programs_covered",
                                "field_type": INT,
                            },
                            {
                                "label": "Summary Notes",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {
                                "label": "Number Recognized",
                                "code": "number_recognized",
                                "field_type": INT,
                            },
                            {
                                "label": "Photos",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {
                                "label": "Total Volunteers Recognized",
                                "code": "total_recognized",
                                "field_type": INT,
                                "is_calculated": True,
                                "formula": "sum(number_recognized)",
                            },
                            {
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {
                                "label": "Tasks Handed Over",
                                "code": "tasks_handed_over",
                                "field_type": MT,
                            },
                            {
                                "label": "Assets Returned",
                                "code": "assets_returned",
                                "field_type": CB,
                            },
                            {
                                "label": "Outstanding Issues",
                                "code": "outstanding_issues",
                                "field_type": MT,
                            },
                            {
                                "label": "Approved By",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "members_retained / (members_start + new_members) * 100",
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "members_lost / (members_start + new_members) * 100",
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {
                                "label": "Reasons for Attrition",
                                "code": "attrition_reasons",
                                "field_type": MT,
                            },
                            {
                                "label": "Retention Strategies",
                                "code": "retention_strategies",
                                "field_type": RT,
                            },
                            {
                                "label": "Recommendations",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {
                                "label": "Capacity Improvement",
                                "code": "capacity_improvement",
                                "field_type": RT,
                            },
                            {
                                "label": "Gaps Identified",
                                "code": "gaps_identified",
                                "field_type": MT,
                            },
                            {
                                "label": "Next Steps",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "role",
                                "field_type": DD,
                                "options": ["Member", "Volunteer", "Staff"],
                            },
                            {
