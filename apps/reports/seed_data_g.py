                        ...
                        "fields": [
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(income.actual)",
                            },
                            {
                                "label": "Total Expenditure",
                                "code": "total_expenditure",
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(expenditure.actual)",
                            },
                            {
                                "label": "Net Balance",
                                "code": "net_balance",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "actual_income - budgeted_income",
                            },
                            {
                                "label": "Income Achievement",
                                "code": "income_achievement",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "actual_income / budgeted_income * 100",
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {
                                "label": "Total Budgeted Expenditure",
                                "code": "budgeted_expenditure",
                                "field_type": DEC,
                            },
                            {
                                "label": "Total Actual Expenditure",
                                "code": "actual_expenditure",
                                "field_type": DEC,
                                "required": True,
                            },
                            {
                                "label": "Expenditure Variance",
                                "code": "expenditure_variance",
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "actual_expenditure - budgeted_expenditure",
                            },
                            {
                                "label": "Expenditure Achievement",
                                "code": "expenditure_achievement",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "actual_expenditure / budgeted_expenditure * 100",
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "bank_balance + cash_in_hand + receivables - payables",
                            },
                            {
                                "label": "Quarterly Forecast",
                                "code": "quarterly_forecast",
                                "field_type": RT,
                            },
                            {
                                "label": "Financial Notes",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "grant_income + donation_income + program_income + other_income",
                            },
                        ],
                    }
                ],
                        ...
                        "fields": [
                            {
                                ...
                                "code": "program_expenditure",
                                "field_type": DEC,
                            },
                            {
                                "label": "Administrative Expenditure",
                                "code": "admin_expenditure",
                                "field_type": DEC,
                            },
                            {
                                "label": "Fundraising Expenditure",
                                "code": "fundraising_expenditure",
                                "field_type": DEC,
                            },
                            {
                                "label": "Total Expenditure",
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "program_expenditure + admin_expenditure + fundraising_expenditure",
                            },
                            {
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "variance / period_budget * 100",
                            },
                            {
                                "label": "Cumulative Actual",
                                "code": "cumulative_actual",
                                "field_type": DEC,
                            },
                            {
                                "label": "Cumulative Achievement",
                                "code": "cumulative_achievement",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "cumulative_actual / annual_budget * 100",
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "variance_amount",
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "actual_amount - budgeted_amount",
                            },
                            {
                                "label": "Variance Percentage",
                                "code": "variance_pct",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "variance_amount / budgeted_amount * 100",
                            },
                            {
                                "label": "Significance",
                                "code": "significance",
                        ...
                        "fields": [
                            {
                                ...
                                "code": "total_variances",
                                "field_type": DEC,
                            },
                            {
                                "label": "High Significance Count",
                                "code": "high_variance_count",
                                "field_type": INT,
                            },
                            {
                                "label": "Management Response",
                                "code": "management_response",
                                "field_type": RT,
                            },
                        ],
                    }
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "status",
                                "field_type": DD,
                                "options": ["Received", "Pending", "Delayed"],
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(inflow.actual_amount)",
                            },
                            {
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "opening_balance + total_inflows - total_outflows",
                            },
                            {
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(expenditure.amount)",
                            },
                            {
                                "label": "Net Balance",
                                "code": "net_balance",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "requisition_date",
                                "field_type": DT,
                            },
                            {
                                "label": "Procurement Method",
                                "code": "procurement_method",
                                "field_type": DD,
                                "options": [
                                    "Direct Purchase",
                                    "Quotation",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(current_value)",
                            },
                            {
                                "label": "Assets Disposed",
                                "code": "assets_disposed",
                                "field_type": INT,
                            },
                            {
                                "label": "New Assets Acquired",
                                "code": "new_assets",
                                "field_type": INT,
                            },
                        ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Issued", "code": "issued", "field_type": INT},
                            {
                                ...
                                "field_type": INT,
                                "is_calculated": True,
                                "formula": "opening_stock + received - issued",
                            },
                            {
                                "label": "Minimum Level",
                                "code": "minimum_level",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "approved_budget",
                                "field_type": DEC,
                            },
                            {
                                "label": "Period Expenditure",
                                "code": "period_expenditure",
                                "field_type": DEC,
                                "required": True,
                            },
                            {
                                "label": "Cumulative Expenditure",
                                "code": "cumulative_expenditure",
                                "field_type": DEC,
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "approved_budget - cumulative_expenditure",
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "cumulative_expenditure / approved_budget * 100",
                            },
                            {
                                "label": "Justification",
                                "code": "justification",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(cumulative_expenditure)",
                            },
                            {
                                "label": "Overall Utilization",
                                "code": "overall_utilization",
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "total_utilized / total_grant * 100",
                            },
                            {
                                "label": "Financial Narrative",
                                "code": "financial_narrative",
                                "field_type": RT,
                            },
                            {
                                "label": "Signed By",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "overall_opinion",
                                "field_type": RT,
                            },
                            {
                                "label": "Audit Signature",
                                "code": "audit_signature",
                                "field_type": SIG,
                            },
                        ],
                    }
