                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Phone", "code": "phone", "field_type": T, "required": True},
                            ...
                            {"label": "Date Joined", "code": "date_joined", "field_type": DT, "required": True},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Members", "code": "total_members", "field_type": INT, "is_calculated": True, "formula": "count(members)"},
                            {"label": "Active Members", "code": "active_members", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Volunteers", "code": "total_volunteers", "field_type": INT, "is_calculated": True, "formula": "count(volunteers)"},
                ...
                "groups": [
                    {
                        ...
                        "code": "beneficiaries",
                        "fields": [
                            {"label": "Beneficiary Number", "code": "beneficiary_number", "field_type": T, "required": True},
                            {"label": "Full Name", "code": "full_name", "field_type": T, "required": True},
                            {"label": "Gender", "code": "gender", "field_type": DD, "options": ["Male", "Female", "Other"], "required": True},
                            {"label": "Date of Birth", "code": "date_of_birth", "field_type": DT},
                            ...
                            {"label": "Beneficiary Type", "code": "beneficiary_type", "field_type": DD, "options": ["Direct", "Indirect", "Community"], "required": True},
                            {"label": "Date Enrolled", "code": "date_enrolled", "field_type": DT, "required": True},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Active", "Completed", "Withdrawn", "Transferred"], "required": True},
                            {"label": "Photo", "code": "photo", "field_type": IMG},
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Beneficiaries", "code": "total_beneficiaries", "field_type": INT, "is_calculated": True, "formula": "count(beneficiaries)"},
                            {"label": "Active Beneficiaries", "code": "active_beneficiaries", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Training Type", "code": "training_type", "field_type": DD, "options": ["Workshop", "Seminar", "Course", "Online", "On-the-Job", "Other"]},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Planned", "Completed", "Cancelled"]},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Trainings", "code": "total_trainings", "field_type": INT, "is_calculated": True, "formula": "count(training_sessions)"},
                            {"label": "Total Participants", "code": "total_participants", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Date", "code": "date", "field_type": DT, "required": True},
                            {"label": "Location", "code": "location", "field_type": T},
                            {"label": "Expected Attendance", "code": "expected_attendance", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Event", "code": "event", "field_type": T, "required": True},
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Email", "code": "email", "field_type": T},
                            {"label": "Phone", "code": "phone", "field_type": T},
                            {"label": "Interest Level", "code": "interest_level", "field_type": DD, "options": ["High", "Medium", "Low"]},
                            {"label": "Influence Level", "code": "influence_level", "field_type": DD, "options": ["High", "Medium", "Low"]},
                            {"label": "Relationship", "code": "relationship", "field_type": DD, "options": ["Strong", "Good", "Neutral", "Weak", "None"]},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Active", "Inactive"]},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Active Stakeholders", "code": "active_stakeholders", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Type", "code": "type", "field_type": DD, "options": ["Bilateral", "Multilateral", "Foundation", "Corporate", "Individual", "Government", "Other"], "required": True},
                            {"label": "Contact Person", "code": "contact_person", "field_type": T},
                            {"label": "Email", "code": "email", "field_type": T},
                            {"label": "Phone", "code": "phone", "field_type": T},
                            {"label": "Address", "code": "address", "field_type": MT},
                            {"label": "Total Contributions", "code": "total_contributions", "field_type": DEC},
                            {"label": "Last Contribution Date", "code": "last_contribution", "field_type": DT},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Active", "Prospect", "Lapsed", "Former"]},
                            {"label": "Relationship Manager", "code": "relationship_manager", "field_type": T},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Donors", "code": "total_donors", "field_type": INT, "is_calculated": True, "formula": "count(donors)"},
                            {"label": "Active Donors", "code": "active_donors", "field_type": INT},
                            {"label": "Total Contributions", "code": "total_contributions", "field_type": DEC, "is_calculated": True, "formula": "sum(total_contributions)"},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Type", "code": "type", "field_type": DD, "options": ["Implementation", "Technical", "Financial", "Advocacy", "Research", "Other"], "required": True},
                            {"label": "Contact Person", "code": "contact_person", "field_type": T},
                            {"label": "Email", "code": "email", "field_type": T},
                            {"label": "Phone", "code": "phone", "field_type": T},
                            {"label": "MoU Start Date", "code": "mou_start", "field_type": DT},
                            {"label": "MoU End Date", "code": "mou_end", "field_type": DT},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Partners", "code": "total_partners", "field_type": INT, "is_calculated": True, "formula": "count(partners)"},
                            {"label": "Active Partners", "code": "active_partners", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Assigned To", "code": "assigned_to", "field_type": T},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["In Use", "In Storage", "Disposed", "Under Repair"]},
                            {"label": "Photo", "code": "photo", "field_type": IMG},
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Assets", "code": "total_assets", "field_type": INT, "is_calculated": True, "formula": "count(assets)"},
                            {"label": "Total Value", "code": "total_value", "field_type": DEC, "is_calculated": True, "formula": "sum(acquisition_cost)"},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "risks",
                        "fields": [
                            {"label": "Risk Reference", "code": "risk_ref", "field_type": T, "required": True},
                            {"label": "Risk Description", "code": "risk_description", "field_type": MT, "required": True},
                            {"label": "Category", "code": "category", "field_type": DD, "options": ["Strategic", "Operational", "Financial", "Compliance", "Reputational", "Safety", "IT", "Other"], "required": True},
                            ...
                            {"label": "Mitigation Measures", "code": "mitigation", "field_type": MT},
                ...
                "groups": [
                    {
                        ...
                        "code": "issues",
                        "fields": [
                            {"label": "Issue Reference", "code": "issue_ref", "field_type": T, "required": True},
                            {"label": "Date Raised", "code": "date_raised", "field_type": DT, "required": True},
                            {"label": "Description", "code": "description", "field_type": MT, "required": True},
                            {"label": "Category", "code": "category", "field_type": DD, "options": ["Operational", "Financial", "HR", "Technical", "Compliance", "Other"], "required": True},
                            {"label": "Priority", "code": "priority", "field_type": DD, "options": ["Critical", "High", "Medium", "Low"], "required": True},
                            {"label": "Assigned To", "code": "assigned_to", "field_type": T},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Open", "In Progress", "Resolved", "Closed", "Escalated"], "required": True},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Issues", "code": "total_issues", "field_type": INT, "is_calculated": True, "formula": "count(issues)"},
                            {"label": "Open Issues", "code": "open_issues", "field_type": INT},
                            {"label": "Resolved Issues", "code": "resolved_issues", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "actions",
                        "fields": [
                            {"label": "Action Reference", "code": "action_ref", "field_type": T, "required": True},
                            {"label": "Date Identified", "code": "date_identified", "field_type": DT, "required": True},
                            {"label": "Source", "code": "source", "field_type": T, "required": True},
                            {"label": "Description", "code": "description", "field_type": MT, "required": True},
                            {"label": "Assigned To", "code": "assigned_to", "field_type": T, "required": True},
                            {"label": "Due Date", "code": "due_date", "field_type": DT, "required": True},
                            {"label": "Priority", "code": "priority", "field_type": DD, "options": ["Critical", "High", "Medium", "Low"], "required": True},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Open", "In Progress", "Completed", "Overdue", "Cancelled"], "required": True},
                            {"label": "Progress", "code": "progress", "field_type": MT},
                            {"label": "Completion Date", "code": "completion_date", "field_type": DT},
                ...
                "groups": [
                    {
                        ...
                        "code": "decisions",
                        "fields": [
                            {"label": "Decision Reference", "code": "decision_ref", "field_type": T, "required": True},
                            {"label": "Date", "code": "date", "field_type": DT, "required": True},
                            {"label": "Meeting/Forum", "code": "meeting_forum", "field_type": T, "required": True},
                            {"label": "Decision", "code": "decision", "field_type": RT, "required": True},
                            {"label": "Rationale", "code": "rationale", "field_type": MT},
                            {"label": "Made By", "code": "made_by", "field_type": T, "required": True},
                            {"label": "Implementation Status", "code": "implementation_status", "field_type": DD, "options": ["Pending", "In Progress", "Implemented", "Not Implemented"]},
                            {"label": "Review Date", "code": "review_date", "field_type": DT},
                            {"label": "Attachments", "code": "attachments", "field_type": DOC, "is_repeatable": True},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Decisions", "code": "total_decisions", "field_type": INT, "is_calculated": True, "formula": "count(decisions)"},
                            {"label": "Implemented", "code": "implemented", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "lessons",
                        "fields": [
                            {"label": "Lesson Reference", "code": "lesson_ref", "field_type": T, "required": True},
                            {"label": "Date Captured", "code": "date_captured", "field_type": DT, "required": True},
                            {"label": "Source", "code": "source", "field_type": T, "required": True},
                            ...
                            {"label": "Lesson Learned", "code": "lesson_learned", "field_type": RT, "required": True},
                            ...
                            {"label": "Validated", "code": "validated", "field_type": CB},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Lessons", "code": "total_lessons", "field_type": INT, "is_calculated": True, "formula": "count(lessons)"},
                            {"label": "Validated Lessons", "code": "validated_lessons", "field_type": INT},
                            {"label": "Applied Lessons", "code": "applied_lessons", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "innovations",
                        "fields": [
                            {"label": "Innovation Reference", "code": "innovation_ref", "field_type": T, "required": True},
                            ...
                            {"label": "Date Proposed", "code": "date_proposed", "field_type": DT, "required": True},
                            {"label": "Description", "code": "description", "field_type": RT, "required": True},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Proposed", "Pilot", "Scaling", "Mainstreamed", "Discontinued"]},
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Mainstreamed", "code": "mainstreamed", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "policies",
                        "fields": [
                            {"label": "Policy Title", "code": "policy_title", "field_type": T, "required": True},
                            {"label": "Policy Number", "code": "policy_number", "field_type": T, "required": True},
                            {"label": "Category", "code": "category", "field_type": DD, "options": ["Governance", "HR", "Finance", "Operations", "Program", "Security", "Safeguarding", "Other"], "required": True},
                            {"label": "Version", "code": "version", "field_type": T},
                            {"label": "Effective Date", "code": "effective_date", "field_type": DT, "required": True},
                            {"label": "Review Date", "code": "review_date", "field_type": DT},
                            {"label": "Owner", "code": "owner", "field_type": T},
                            {"label": "Status", "code": "status", "field_type": DD, "options": ["Active", "Under Review", "Expired", "Draft"], "required": True},
                            {"label": "Policy Document", "code": "policy_document", "field_type": DOC},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Policies", "code": "total_policies", "field_type": INT, "is_calculated": True, "formula": "count(policies)"},
                            {"label": "Active Policies", "code": "active_policies", "field_type": INT},
                            {"label": "Policies Due for Review", "code": "due_for_review", "field_type": INT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "meetings",
                        "fields": [
                            {"label": "Meeting Title", "code": "meeting_title", "field_type": T, "required": True},
                            {"label": "Meeting Type", "code": "meeting_type", "field_type": DD, "options": ["Board", "Staff", "Committee", "Team", "Annual General", "Extraordinary", "Other"], "required": True},
                            {"label": "Date", "code": "date", "field_type": DT, "required": True},
                            {"label": "Time", "code": "time", "field_type": TM},
                            {"label": "Location", "code": "location", "field_type": T},
                            {"label": "Chairperson", "code": "chairperson", "field_type": T},
                            {"label": "Minutes Taker", "code": "minutes_taker", "field_type": T},
                            {"label": "Attendees", "code": "attendees", "field_type": MT},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Meetings", "code": "total_meetings", "field_type": INT, "is_calculated": True, "formula": "count(meetings)"},
                            {"label": "Meeting Types", "code": "meeting_types", "field_type": MT},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "events",
                        "fields": [
                            {"label": "Event Title", "code": "event_title", "field_type": T, "required": True},
                            {"label": "Event Type", "code": "event_type", "field_type": DD, "options": ["Workshop", "Conference", "Seminar", "Training", "Celebration", "Outreach", "Other"], "required": True},
                            {"label": "Date", "code": "date", "field_type": DT, "required": True},
                            {"label": "Location", "code": "location", "field_type": T},
                            {"label": "Organizer", "code": "organizer", "field_type": T},
                            {"label": "Expected Participants", "code": "expected_participants", "field_type": INT},
                            {"label": "Actual Participants", "code": "actual_participants", "field_type": INT},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Events", "code": "total_events", "field_type": INT, "is_calculated": True, "formula": "count(events)"},
                            {"label": "Completed Events", "code": "completed_events", "field_type": INT},
                            {"label": "Total Participants", "code": "total_participants", "field_type": INT},
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {"label": "Title", "code": "title", "field_type": T, "required": True},
                            {"label": "Media Type", "code": "media_type", "field_type": DD, "options": ["Print", "Online", "Broadcast", "TV", "Radio", "Social Media", "Other"], "required": True},
                            {"label": "Media House", "code": "media_house", "field_type": T},
                ...
                "groups": [
                    {
                        ...
                        "code": "summary",
                        "fields": [
                            {"label": "Total Media Items", "code": "total_media", "field_type": INT, "is_calculated": True, "formula": "count(media_items)"},
                            {"label": "Positive Coverage", "code": "positive_coverage", "field_type": INT},
                ...
                "groups": [
                    {
                        ...
                        "code": "grants",
                        "fields": [
                            {"label": "Grant Reference", "code": "grant_ref", "field_type": T, "required": True},
                            ...
                            {"label": "Utilized", "code": "utilized", "field_type": DEC},
                            {"label": "Remaining", "code": "remaining", "field_type": DEC, "is_calculated": True, "formula": "amount - utilized"},
                            {"label": "Project", "code": "project", "field_type": T},
                            {"label": "Agreement", "code": "agreement", "field_type": DOC},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Total Utilized", "code": "total_utilized", "field_type": DEC, "is_calculated": True, "formula": "sum(utilized)"},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "code": "proposals",
                        "fields": [
                            {"label": "Proposal Reference", "code": "proposal_ref", "field_type": T, "required": True},
                            {"label": "Title", "code": "title", "field_type": T, "required": True},
                            {"label": "Donor", "code": "donor", "field_type": T, "required": True},
                            ...
                            {"label": "Lead Writer", "code": "lead_writer", "field_type": T},
                            {"label": "Proposal Document", "code": "proposal_document", "field_type": DOC},
                        ],
                    }
                ],
            },
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            {"label": "Approved Proposals", "code": "approved_proposals", "field_type": INT},
