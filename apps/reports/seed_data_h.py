                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "grant_amount - utilized_amount",
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "utilized_amount / grant_amount * 100",
                            },
                            {
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "total_utilized / total_value * 100",
                            },
                        ],
                    }
                ],
                        ...
                        "fields": [
                            {
                                ...
                                "code": "total_partnerships",
                                "field_type": INT,
                                "is_calculated": True,
                                "formula": "count(partnerships)",
                            },
                            {
                                "label": "Active Partnerships",
                                "code": "active_partnerships",
                                "field_type": INT,
                            },
                            {
                                "label": "Key Outcomes",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "total_raised / total_target * 100",
                            },
                            {
                                "label": "Total Costs",
                                "code": "total_costs",
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "(total_raised - total_costs) / total_costs * 100",
                            },
                        ],
                    }
                ],
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "code": "total_net_income",
                                "field_type": DEC,
                                "is_calculated": True,
                                "formula": "sum(net_income)",
                            },
                            {
                                "label": "Diversification Score",
                                "code": "diversification_score",
                                "field_type": DEC,
                            },
                            {
                                "label": "Recommendations",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            {
                                "label": "Total Funds Raised YTD",
                                "code": "funds_raised_ytd",
                                "field_type": DEC,
                            },
                            {
                                "label": "Annual Target",
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "funds_raised_ytd / annual_target * 100",
                            },
                            {
                                "label": "Active Grants",
                                "code": "active_grants",
                ...
                "groups": [
                    {
                        ...
                        "fields": [
                            ...
                            },
                            {
                                ...
                                "field_type": PCT,
                                "is_calculated": True,
                                "formula": "amount / total_raised * 100",
                            },
                        ],
                    }
                ],
