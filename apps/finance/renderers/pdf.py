...
class FinancePDFRenderer(BaseFinanceRenderer):
    ...
    def _render_with_weasyprint(self) -> bytes:
        ...
        html_string = render_to_string('finance/report_pdf.html', self._get_template_context())
    ...
    def _render_with_reportlab(self) -> bytes:
        ...
        # Timestamp
        story.append(Paragraph(f"Generated on: {self.timestamp.strftime('%Y-%m-%d %H:%M:%S')}", styles['Normal']))
