...
class PolicyAdmin(BaseGovernanceAdmin):
    ...
    list_filter = (
        *BaseGovernanceAdmin.list_filter,
        "policy_category",
        "version",
        "status",
    )
    ...
    fieldsets = (
        ...
        (_("Version Control"), {"fields": ("version", "supersedes")}),
        (
            _("Lifecycle"),
            {"fields": ("effective_date", "expiry_date", "review_date", "status")},
        ),
        (_("Responsibility"), {"fields": ("responsible_officer",)}),
...
class RiskRegisterAdmin(BaseGovernanceAdmin):
    ...
    def risk_rating_display(self, obj):
        ...
        return format_html(
            '<span style="color: {}; font-weight: bold;">{}</span>', color, risk_rating
        )
    ...
    fieldsets = (
        ...
        (_("Review Schedule"), {"fields": ("review_date", "status")}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class RiskAssessmentAdmin(BaseGovernanceAdmin):
    ...
    readonly_fields = (
        *BaseGovernanceAdmin.readonly_fields,
        "risk_score",
        "created_at",
        "updated_at",
    )
...
class RiskTreatmentPlanAdmin(BaseGovernanceAdmin):
    ...
    search_fields = (
        "risk_register__title",
        "description",
        "responsible_officer__first_name",
        "responsible_officer__last_name",
    )
    readonly_fields = (*BaseGovernanceAdmin.readonly_fields, "created_at", "updated_at")
...
class ComplianceRequirementAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Lifecycle"), {"fields": ("effective_date", "expiry_date", "is_active")}),
        (
            _("Audit Information"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ComplianceAssessmentAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Evidence"), {"fields": ("evidence_documents",)}),
        (
            _("Audit Information"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class EthicsCaseAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        (_("Case Information"), {"fields": ("title", "case_type", "description")}),
        (_("Reporting"), {"fields": ("reported_by", "reported_date")}),
        (
            _("Investigation"),
            {
                "fields": (
        ...
        (_("Resolution"), {"fields": ("resolution", "outcome", "lessons_learned")}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class ConflictOfInterestDeclarationAdmin(BaseGovernanceAdmin):
    ...
    search_fields = (
        "declarant__first_name",
        "declarant__last_name",
        "nature_of_conflict",
    ...
    fieldsets = (
        ...
        (_("Timeline"), {"fields": ("date_declared", "review_date")}),
        (
...
class SafeguardingCaseAdmin(BaseGovernanceAdmin):
    ...
    def get_queryset(self, request):
        from apps.governance.permissions import user_can_view_safeguarding
    ...
    fieldsets = (
        (_("Case Information"), {"fields": ("title", "case_category", "description")}),
        (_("Reporting"), {"fields": ("reported_by", "date_reported")}),
        (_("Risk Assessment"), {"fields": ("risk_level",)}),
        (
            _("Investigation"),
            {
                "fields": (
        ...
        (_("Outcome"), {"fields": ("actions_taken", "outcome", "closure_date")}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class IncidentReportAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Timing"), {"fields": ("date_occurred", "date_reported")}),
        (_("Location & Severity"), {"fields": ("location", "severity")}),
        (_("Reporting"), {"fields": ("reported_by",)}),
        (
            _("Response"),
            {
                "fields": (
        ...
        (_("Related Records"), {"fields": ("safeguarding_case",)}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class ComplaintAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Context"), {"fields": ("programme", "service_location")}),
        (
            _("Investigation"),
            {
                "fields": (
        ...
        (_("Learning"), {"fields": ("lessons_learned",)}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class WhistleblowerReportAdmin(BaseGovernanceAdmin):
    ...
    def get_queryset(self, request):
        from apps.governance.permissions import user_can_view_whistleblower
    ...
    fieldsets = (
        (_("Report Information"), {"fields": ("title", "report_type", "description")}),
        (
        ...
        (_("Alleged Subjects"), {"fields": ("alleged_subjects",)}),
        (
            _("Investigation"),
            {
                "fields": (
        ...
        (_("Evidence"), {"fields": ("evidence_documents",)}),
        (_("Outcome"), {"fields": ("outcome", "date_closed")}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class CorrectivePreventiveActionAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        (_("Action Information"), {"fields": ("title", "action_type", "description")}),
        (
            _("Source Issue"),
            {
                "fields": (
        ...
        (_("Effectiveness"), {"fields": ("effectiveness_rating", "lessons_learned")}),
        (
            _("Audit Information"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class DocumentAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Access Control"), {"fields": ("confidentiality_level",)}),
        (
            _("Related Records"),
            {
                "fields": (
...
class GovernanceMeetingAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Leadership"), {"fields": ("meeting_chair",)}),
        (_("Content"), {"fields": ("minutes", "action_items", "decisions_made")}),
        (
            _("Audit Information"),
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
...
class MeetingAttendanceAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Timing"), {"fields": ("joined_at", "left_at")}),
        (_("Notes"), {"fields": ("apologies_note",)}),
        (
            _("Audit Information"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class GovernanceNotificationAdmin(BaseGovernanceAdmin):
    ...
    fieldsets = (
        ...
        (_("Recipient & Status"), {"fields": ("recipient", "is_read", "read_at")}),
        (_("Delivery"), {"fields": ("sent_via_email", "sent_via_sms", "sent_at")}),
        (
            _("Audit Information"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
